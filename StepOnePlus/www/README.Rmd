---
title: "StepOnePlus Analysis App README"
...
![*Figure 1. The "Define Targets and Samples" tab.*](img/define_targets_and_samples.JPG)
...
![*Figure 2. The "View Plate Layout" of the "Assign Targets and Samples" tab. Note that the highlighed well (B2) has a Target of miR166, a Task of Unknown, a Sample of At2, and a Biological Group of At.*  ](img/assign_targets_and_samples_plate_b2.JPG)

![*Figure 3. The "View Well Table" of the "Assign Targets and Samples" tab. Note that the highlighed well (B2) has a Target of miR166, a Task of Unknown, a Sample of At2, and a Biological Group of At.  *](img/assign_targets_and_samples_well_b2.JPG)
...
![*Figure 4. Exporting data from the StepOnePlus software.*](img/export_data.JPG)
...
![*Figure 5. Formula for relative expression.*](img/RE_formula.jpg)
